...
QIcon loadThemedSidebarSvgIcon(const QString& resourcePath, bool isDark) {
    ...
    const QString color = isDark ? "#FFFFFF" : "#1D1D1F";
    ...
    : QMainWindow(parent)
{
    ...
    connect(m_userAgreementOverlay, &UserAgreementOverlay::agreementAccepted, this, [this]() {
        // Check login status after agreement is accepted
...
void MainWindow::setupSidebar() {
    ...
    m_toolsBtn->setIcon(loadThemedSidebarSvgIcon(":/icons/toolbox.svg", ConfigManager::instance().isCurrentThemeDark()));
    ...
    m_accountBtn->setIcon(loadThemedSidebarSvgIcon(":/icons/user.svg", ConfigManager::instance().isCurrentThemeDark()));
    ...
    m_settingsBtn->setIcon(loadThemedSidebarSvgIcon(":/icons/settings.svg", ConfigManager::instance().isCurrentThemeDark()));
    ...
    m_configBtn->setIcon(loadThemedSidebarSvgIcon(":/icons/folder.svg", ConfigManager::instance().isCurrentThemeDark()));
...
void MainWindow::applyTheme() {
    ...
    m_toolsBtn->setIcon(loadThemedSidebarSvgIcon(":/icons/toolbox.svg", isDark));
    m_accountBtn->setIcon(loadThemedSidebarSvgIcon(":/icons/user.svg", isDark));
    m_settingsBtn->setIcon(loadThemedSidebarSvgIcon(":/icons/settings.svg", isDark));
    m_configBtn->setIcon(loadThemedSidebarSvgIcon(":/icons/folder.svg", isDark));
    ...
    connect(m_updateOverlay, &Update::updateCheckCompleted, this, [this](bool hasUpdate) {
        if (hasUpdate) {
            ...
            if (SetupDialog::isConfigValid()) {
                // Config is valid, skip setup and load files directly
                Logger::instance().logInfo("MainWindow", "Config valid, skipping setup, loading files");
                m_loadingOverlay->showOverlay();
                m_scanCheckTimer->start();
                FileManager::instance().startScanning();
                show();
